...
slug: a-musicxml-tutorial-part-4-non-western-notation
date: 2025-11-11
updated: 2026-06-03
tags: ['x', 'Music', 'MusicXML']
description: In part four of this series we'll explore some of the ways MusicXML can accommodate non-Western notation.
---
...
osmd.rules.RenderTimeSignatures = false;// [!code ++]
osmd.load('score.musicxml').then(() => osmd.render());
```

This should leave us with our intended starting point.

<iframe height="400" class="codepen" scrolling="no" title="MusicXML Tutorial 4.1" src="https://codepen.io/davidmatthew/embed/ogbdJLg?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/ogbdJLg">
  MusicXML Tutorial 4.1</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
...
<figure>
  <img src="https://upload.wikimedia.org/wikipedia/commons/3/33/Circle_of_fifths_deluxe_4.svg" alt="Circle of Fifths">
...
<iframe height="400" class="codepen" scrolling="no" title="MusicXML Tutorial 4.2" src="https://codepen.io/davidmatthew/embed/jEWeVwx?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/jEWeVwx">
  MusicXML Tutorial 4.2</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>
...
<score-partwise version="4.0">
  <defaults><!--[!code ++]-->
    <lyric-language xml:lang="ga" /><!--[!code ++]-->
  </defaults><!--[!code ++]-->
  <part-list>
    <score-part id="p1">
...
...
<work><!--[!code ++]-->
  <work-title>Ar Shiúl Uaim</work-title><!--[!code ++]-->
</work><!--[!code ++]-->
<part-list>
```
...
<iframe height="400" class="codepen" scrolling="no" title="MusicXML Tutorial 4.3" src="https://codepen.io/davidmatthew/embed/ZYQwJWz?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/ZYQwJWz">
  MusicXML Tutorial 4.3</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>

## Missing Pieces

While writing this tutorial I got excellent guidance from an expert in this area, <a href="https://blog.karimratib.me/about/" target="_blank">Karim Ratib</a>, who was <a href="https://www.w3.org/community/music-notation/2026/01/27/new-musicxml-specification-editor-appointment/" target="_blank">recently appointed as the new MusicXML editor</a> and is actively working on extending the specification to accommodate a wider range of music. Specifically, he is working on:
...
This would indeed make MusicXML a more universal format. I interviewed him for [the conclusion to this series](/musicxml-tips-thoughts-karim-ratib/) to get his insights on the future of MusicXML, and tips for developers working with the standard.
