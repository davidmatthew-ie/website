...
slug: a-musicxml-tutorial-part-3-rests-ties-tuplets-beams-barlines
date: 2025-10-07
tags: ['Music', 'MusicXML']
description: In part three of this series, we'll bring this first example score to completion and explore rests, ties, tuplets, beams and barlines in the process.
---
...
<iframe height="520" class="codepen" scrolling="no" title="MusicXML Tutorial Part 2.4" src="https://codepen.io/davidmatthew/embed/azbLGZo?default-tab=js%2Cresult&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/azbLGZo">
  MusicXML Tutorial Part 2.4</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
...
<note>
  ...
  <duration>4</duration><!--[!code highlight]-->
  <type>half</type><!--[!code highlight]-->
  <duration>2</duration><!--[!code ++]-->
  <type>quarter</type><!--[!code ++]-->
...
```xml
<notations>
  <tied type="start"/><!--[!code highlight]-->
  <tied type="stop"/><!--[!code ++]-->
</notations>
```
...
<iframe height="550" class="codepen" scrolling="no" title="MusicXML Tutorial Part 3.1" src="https://codepen.io/davidmatthew/embed/azvMJda?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/azvMJda">
  MusicXML Tutorial Part 3.1</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>
...
<note>
  ...
  <duration>2</duration><!--[!code highlight]-->
  <duration>1</duration><!--[!code ++]-->
  <voice>1</voice>
  <type>quarter</type><!--[!code highlight]-->
  <type>eighth</type><!--[!code ++]-->
  <staff>1</staff>
</note>
```
...
<note>
  <pitch>
    ...
    ...
  <staff>1</staff>
  <beam number="1">end</beam><!--[!code ++]-->
</note>
```

Now the notes should be beamed together like so:

<iframe height="550" class="codepen" scrolling="no" title="MusicXML Tutorial Part 3.2" src="https://codepen.io/davidmatthew/embed/ogbYwVL?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/ogbYwVL">
  MusicXML Tutorial Part 3.2</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>
...
<note>
  ...
  ...
  <notations><!--[!code ++]-->
    <tuplet type="start" bracket="no" placement="above" /><!--[!code ++]-->
  </notations><!--[!code ++]-->
</note>
```
...
<note>
  ...
  ...
  <beam number="1">begin</beam>
  <time-modification><!--[!code ++]-->
    <actual-notes>3</actual-notes><!--[!code ++]-->
    <normal-notes>2</normal-notes><!--[!code ++]-->
  </time-modification><!--[!code ++]-->
  <notations>
...
<backup>
  ...
  <duration>7</duration><!--[!code ++]-->
</backup>
```

Now the tuplet should look right.

<iframe height="550" class="codepen" scrolling="no" title="MusicXML Tutorial Part 3.3" src="https://codepen.io/davidmatthew/embed/MYKboRx?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/MYKboRx">
  MusicXML Tutorial Part 3.3</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>
...
<iframe height="550" class="codepen" scrolling="no" title="MusicXML Tutorial Part 3.4" src="https://codepen.io/davidmatthew/embed/xbZqBvB?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/xbZqBvB">
  MusicXML Tutorial Part 3.4</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
  on <a href="https://codepen.io">CodePen</a>.
</iframe>

## Summary

In this tutorial we explored rests, ties, tuplets, beams and barlines, and the difference between elements intended to describe the notated music, and elements intended to represent its sonic realisation. In [the next part of the series](/a-musicxml-tutorial-part-4-non-western-notation/), we'll start a new example score and show how MusicXML can handle non-Western music notation.