...
slug: creating-an-oscilloscope-with-javascript
date: 2022-05-12
updated: 2025-07-01
tags: ['x', 'JavaScript', 'Web Audio']
description: A fun tutorial teaching you how to create an oscilloscope with plain JavaScript and the Web Audio API.
---
...
<iframe height="600" class="codepen" scrolling="no" title="Oscilloscope" src="https://codepen.io/davidmatthew/embed/dyJEbwr?default-tab=result&editable=true&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true">
  See the Pen <a href="https://codepen.io/davidmatthew/pen/dyJEbwr">
  Oscilloscope</a> by David Matthew (<a href="https://codepen.io/davidmatthew">@davidmatthew</a>)
