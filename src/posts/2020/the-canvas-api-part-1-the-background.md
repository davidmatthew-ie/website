...
slug: the-canvas-api-part-1-the-background
date: 2020-10-04
tags: ["Canvas", "JavaScript"]
description: In this four-part series, we'll explore the HTML Canvas and how to create dynamic interactive graphics natively for the web with JavaScript.
---
...
<span class="[&>p]:grid [&>p]:grid-cols-2 [&>p]:gap-4">

![Linear II](../../media/2020/tyler-hobbs-linear-ii-detail-2-1.jpg)
![Cuda](../../media/2020/cuda.jpg)
